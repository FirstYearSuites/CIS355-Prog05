...
class Customer {
    ...
    private function generate_html_bottom ($fun) {
        ...
        echo " 
                            <div class='form-actions'>
                                $funButton
                                <a class='btn btn-secondary' href='http://csis.svsu.edu/~bhfalor/5/$this->urlName.php'>Back</a>
                            </div>
                        </form>
                    </div>
                </div> <!-- /container -->
    ...
    function list_records() {
        ...
        foreach ($pdo->query($sql) as $row) {
            ...
            echo "<a class='btn btn-info' href='http://csis.svsu.edu/~bhfalor/5/$this->urlName.php?fun=display_read_form&id=".$row["id"]."')>Read</a>";
            echo "&nbsp;";
            echo "<a class='btn btn-warning' href='http://csis.svsu.edu/~bhfalor/5/$this->urlName.php?fun=display_update_form&id=".$row["id"]."'>Update</a>";
            echo "&nbsp;";
            echo "<a class='btn btn-danger' href='http://csis.svsu.edu/~bhfalor/5/$this->urlName.php?fun=display_delete_form&id=".$row["id"]."'>Delete</a>";
            echo "</td>";
            echo "</tr>";
        }
        Database::disconnect();
